    ...
    <div ref={wrapperRef} style={{ position: 'relative' }}>
      <div
        ...
        style={{
          ...
          alignItems: 'center', color: selectedLabel ? '#17372C' : '#94a3b8',
...
export default function LandTitles() {
  ...
  const handleExportCSV = () => {
    ...
    const headers = ['Plot Number', 'Block', 'Owner Name', 'Sub-county / District', 'Location', 'County', 'Title Type', 'Status', 'Date Received', 'Storage Location'];
  ...
  return (
    <div style={styles.container}>
      ...
      <section style={styles.statsGrid}>
        <StatCard label="Total Titles" value={stats.total} color="#17372C" />
            ...
            {filteredTitles.length === 0 ? (
              ...
              filteredTitles.map(t => (
                <tr key={t.id} style={styles.tableRow}>
                  <td style={styles.td}>
                    <div style={{ fontWeight: 800, color: '#17372C' }}>Plot {t.title_number}</div>
  ...
  return (
    <div style={{ ...styles.statCard, borderTop: `4px solid ${color}` }}>
      <div style={styles.statContent}>
        ...
        <span style={{ ...styles.statValue, color: isUrgent ? '#ef4444' : '#17372C' }}>{value}</span>
      </div>
    </div>
  );
}
      ...
      <div style={styles.modalContent}>
        ...
        <form onSubmit={handleSubmit} style={styles.form}>
          <div style={styles.formGrid}>
            ...
            <div style={styles.formGroup}>
              <label style={styles.label}>Sub-county / District *</label>
              <input required type="text" placeholder="Enter sub-county or district" style={styles.input}
...
const styles: Record<string, React.CSSProperties> = {
  ...
  title: { fontSize: '28px', fontWeight: 900, color: '#17372C', margin: 0, letterSpacing: '-0.5px' },
  subtitle: { fontSize: '14px', color: '#64748b', marginTop: '4px' },
  headerActions: { display: 'flex', gap: '12px' },
  exportBtn: { padding: '10px 18px', backgroundColor: 'white', border: '1px solid #e2e8f0', borderRadius: '10px', color: '#27664D', fontSize: '14px', fontWeight: 600, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '8px' },
  addBtn: { padding: '10px 18px', backgroundColor: '#17372C', border: 'none', borderRadius: '10px', color: 'white', fontSize: '14px', fontWeight: 600, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '8px', boxShadow: '0 4px 12px rgba(11, 31, 58, 0.15)' },
  ...
  filterSelect: { padding: '10px 16px', border: '1px solid #e2e8f0', borderRadius: '8px', fontSize: '14px', color: '#27664D', outline: 'none', cursor: 'pointer', backgroundColor: '#f8fafc' },
  ...
  td: { padding: '16px 24px', fontSize: '14px', color: '#27664D', verticalAlign: 'middle' },
  ...
  modalTitle: { fontSize: '20px', fontWeight: 900, color: '#17372C', margin: 0 },
