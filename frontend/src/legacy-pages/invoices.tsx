            ...
            <form onSubmit={handleSave} className="flex flex-col flex-1 overflow-hidden">
              <div className="overflow-y-auto flex-1 px-6 py-5 space-y-4">
                ...
                <div className="bg-[#17372C]/5 p-4 rounded-xl border border-[#17372C]/10">
                  ...
                  <input type="number" className="w-full bg-white border-none p-3 rounded-lg text-base font-bold" value={amountBilled || ""} onChange={e => setAmountBilled(Number(e.target.value))} placeholder="Total Gross Amount" />
              ...
              {/* Sticky Footer */}
              <div className="px-6 py-4 border-t border-gray-100 bg-white flex-shrink-0 flex gap-3">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse">
            <thead className="underline bg-gray-50 text-[12px] font-black text-black-400 uppercase tracking-widest">
              <tr>
                <th className="p-5">Matter & Ref</th>
                <th className="p-5 text-right">Age</th>
                <th className="p-5 text-right">Amount Billed</th>
                <th className="p-5 text-right">AmountPaid</th>
                ...
                return (
                  <tr key={inv.id} className="hover:bg-[#FBFAF6] transition group">
                    ...
                    <td className="p-5 text-right">
                      <span className={`text-xs font-bold ${age > 30 && !inv.isPaid ? 'text-red-600' : 'text-black-400'}`}>
                        {inv.isPaid ? '—' : `${age}d`}
                      </span>
                    </td>
                      ...
                      <div className="flex flex-col items-center gap-2">
                        ...
                        <div className="flex flex-wrap gap-1 justify-center">
                          ...
                          <button
                            ...
                            className="underline hover:bg-red-100 text-red-500 text-[10px] font-black px-2.5 py-1.5 rounded-lg transition-colors"
                          >Delete</button>
                        </div>
                      </div>
                    </td>
